...
public class ClientDetailsViewBuilder implements CustomerDetailsViewBuilder {
    ...
    public View buildOverviewView() {
        ...
        textView = (TextView)view.findViewById(R.id.customerOverview_phoneNumber);
        if (!TextUtils.isEmpty(mDetails.getAddress().getPhoneNumber().trim())) {
        	textView.setText(mDetails.getAddress().getPhoneNumber());    
        }
